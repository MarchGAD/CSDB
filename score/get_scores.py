...
if __name__ == '__main__':
    ...
    for epoch in args.epochs:
        ...
        scorer = Scorer(model_path=model_path,
                        scp_path=params.test_scp_path,
                        trials_path=dirpath + '/trials', batch_size=50,
                        use_gpu=args.use_gpu, 
                        mgr=mp.Manager(), processes=None)
        # pre = time.time()
        ...
        scorer.save_scores(dirpath + '/test_scores.txt')
        from score.eer_and_mindcf import Resulter
        a = Resulter(dirpath + '/test_scores.txt', dirpath + '/trials')
